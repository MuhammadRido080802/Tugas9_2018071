...
import com.example.a2018071_tugas3prak.databinding.ActivityDatamenuBinding;

import java.io.ByteArrayOutputStream;


public class Datamenu extends AppCompatActivity {
    private ActivityDatamenuBinding binding;
    DBmain dBmain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDatamenuBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec =
                        sqLiteDatabase.insert("tradisional", null, cv);
                if (rec != null) {
                    Toast.makeText(Datamenu.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Datamenu.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Datamenu.this, DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(Datamenu.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(Datamenu.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
